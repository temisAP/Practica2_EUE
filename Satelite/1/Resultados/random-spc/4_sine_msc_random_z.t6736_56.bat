...
set datecmd=%datecmd:/=\%
set exedir=
set jobnt=./4_sine_msc_random_z.T6736_56
set jobnt=%jobnt:/=\%
...
set MSC_AUTH=EDU
set MSC_BASE=c:/program files/msc.software/napa_se/2020/nastran
set MSC_DBS=./4_sine_msc_random_z
...
set MSC_ISHELLEXT=
set MSC_JID=c:/muse/eue/practica2_eue/satelite/1/analisis/4_sine_msc_random_z.dat
set MSC_JIDPATH=
set MSC_JIDTYPE=.dat
set MSC_MEM=637MB
set MSC_OLD=yes
...
set cmdline=C:\Program Files\MSC.Software\NaPa_SE\2020\Nastran\msc20200\win64i8\nastran.exe JID=C:\MUSE\EUE\Practica2_EUE\Satelite\1\Analisis\4_sine_msc_random_z.dat
...
if exist "4_sine_msc_random_z.perf" "c:/program files/msc.software/napa_se/2020/nastran/bin/msc20200" mscsystem 4_sine_msc_random_z.perf >> %lognt%
if exist "%sdirnt%\4_sine_msc_random_z.T6736_56.perf" "c:/program files/msc.software/napa_se/2020/nastran/bin/msc20200" mscsystem %sdirnt%\4_sine_msc_random_z.T6736_56.perf >> %lognt%
@rem
set /a f98 = 0
call :get_file_size  "%sdirnt%\4_sine_msc_random_z.T6736_56.f98"
if /i %FILE_SIZE% gtr 0 set /a f98 = 1
set /a f99 = 0
call :get_file_size  "%sdirnt%\4_sine_msc_random_z.T6736_56.f99"
...
if /i %i% neq 0 (
   ...
   if "%ferr%" == "" (
      if /i %f98% neq 0 (
         if /i %f99% neq 0 copy /f /y "%sdirnt%\4_sine_msc_random_z.T6736_56.f99"+"%sdirnt%\4_sine_msc_random_z.T6736_56.f98" "%outnt%.acms_out"
         if /i %f99% equ 0 copy /f /y "%sdirnt%\4_sine_msc_random_z.T6736_56.f98" "%outnt%.acms_out"
      ) else (
         copy /f /y "%sdirnt%\4_sine_msc_random_z.T6736_56.f99" "%outnt%.acms_out"
      )
   )
)
@rem
...
for %%f in ("%sdirnt%\4_sine_msc_random_z.T6736_56.*") do call :delete_job_file "%%f"
